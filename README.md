# Storing Gemini embeddings in Postgres with pgvector
...
> 🆕 Supabase has released an open source toolkit for developing AI applications using Postgres and pgvector. Learn more in the [AI & Vectors docs](https://supabase.com/docs/guides/ai).
